      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            {/* Map placeholder */}
            <div className="mt-6 rounded-xl overflow-hidden bg-white/5 border border-white/10 h-36 flex items-center justify-center">
              <a
                href="https://go.2gis.com/shymkent"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 text-sm hover:text-mint transition-colors flex flex-col items-center gap-2"
              >
                <MapPin size={24} />
                Открыть на 2GIS
              </a>
