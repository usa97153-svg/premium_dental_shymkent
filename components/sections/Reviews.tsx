...
const reviews = [
  ...
  },
  {
    ...
    date: "апрель 2025",
    rating: 5,
    text: "Была в этой стоматологии и осталась очень довольна! Оборудование современное, всё чисто и стерильно. Врачи профессионалы своего дела, всё объясняют понятно и внимательно относятся к пациентам. Цены приемлемые за такой уровень. Рекомендую!",
    avatar: "АК",
  ...
  },
  {
    ...
    date: "июнь 2026",
    rating: 5,
    text: "Жақсылық врачқа рақмет — тісімді ауырсынусыз жұлып берді және тісіме чистка жасаттым, тап таза етіп тазалап берді. Көмекші қыздарға да рақмет — ем біткенше балаларыма қарап берді!",
    avatar: "ТК",
