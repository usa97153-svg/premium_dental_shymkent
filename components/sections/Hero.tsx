          ...
          <div>
            ...
            >
              <motion.a
                ...
                className="flex items-center justify-center gap-2 bg-mint text-white font-bold px-7 py-3.5 rounded-2xl shadow-lg shadow-emerald-200 hover:bg-emerald-500 transition-colors text-base"
              >
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                href="#pricing"
                className="flex items-center justify-center gap-2 bg-white border-2 border-primary text-primary font-bold px-7 py-3.5 rounded-2xl hover:bg-blue-50 transition-colors text-base"
              >
                Узнать цены
              </motion.a>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <div className="text-sm font-bold text-navy">от 120 000 ₸</div>
              </div>
            </motion.div>
