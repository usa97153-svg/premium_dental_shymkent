...
import { Phone, MessageCircle, Star, Clock, ChevronDown } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            {/* Buttons — plain <a> tags for mobile compatibility */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <a
                ...
                className="flex items-center justify-center gap-2 bg-mint text-white font-bold px-7 py-4 rounded-2xl shadow-lg hover:bg-emerald-500 transition-colors text-base active:scale-95"
              >
                <MessageCircle size={20} />
                Записаться в WhatsApp
              </a>
              <a
                href="https://premium-dental-shymkent-git-main-webly1.vercel.app/#pricing"
                className="flex items-center justify-center gap-2 bg-white border-2 border-primary text-primary font-bold px-7 py-4 rounded-2xl hover:bg-blue-50 transition-colors text-base active:scale-95"
              >
                Узнать цены
              </a>
            </motion.div>
